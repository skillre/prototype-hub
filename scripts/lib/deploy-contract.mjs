 ...
 * Why this exists
 * ===========================================================================
 * An earlier prototype's release phase produced six facts that were **not in any
 ...
 * in `docs/deployment.md` and `AGENTS.md`, where an agent actually reads
 ...
 *
 * This table is the contract. `docs/deployment.md` restates it for humans
